...
#    if lowercase[0] == 'From' and len(lowercase)>0:
#        if any(ele in lowercase for ele in days):
#        #checks if any words in the lowercase string are one of the elements in the list days. Outputs a true or false statement. If true, then you move forward. 
#            for written_days in days: 
#            #for loop to go through each element in days list. written_days is the iterating variable. 
#                if written_days in lowercase: 
